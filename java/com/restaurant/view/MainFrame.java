...
import com.restaurant.view.admin.OrdersPanel;
...
public class MainFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        billPanel = new BillPanel(this,cartController);
    ...
    public void refreshAdminOrders() {
        for (Window w : Window.getWindows()) {
            if (w instanceof AdminFrame && w.isVisible()) {
                ((AdminFrame) w).refreshOrders();
            }
        }
    }
    public void refreshOrders() {
        // Tìm OrdersPanel trong tabbedPane và gọi refresh
        for (int i = 0; i < tabbedPane.getTabCount(); i++) {
            Component comp = tabbedPane.getComponentAt(i);
            if (comp instanceof OrdersPanel) {
                ((OrdersPanel) comp).refreshOrders();
                break;
            }
        }
    }
